...
extern int32_t ece391_delete(uint8_t* buf);
extern int32_t ece391_copy(uint8_t* src, uint8_t* dsc);
extern int32_t ece391_ps (void);
extern int32_t ece391_color (uint8_t text_color, uint8_t background_color);
