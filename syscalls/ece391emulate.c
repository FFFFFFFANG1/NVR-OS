...
extern int32_t __ece391_create(uint8_t* buf);
extern int32_t __ece391_delete(uint8_t* buf);
extern int32_t __ece391_copy(uint8_t* src, uint8_t* dsc);
extern int32_t __ece391_ps (void);
extern int32_t __ece391_color(uint8_t text_color, uint8_t background_color);
void fake_function () {
...
DO_CALL(__ece391_create,12 /*SYS_CREATE*/);
DO_CALL(__ece391_delete,13 /*SYS_DELETE*/);
DO_CALL(__ece391_copy,14 /*SYS_COPY*/);DO_CALL(__ece391_ps,11 /* SYS_PS */);
DO_CALL(__ece391_color,15 /* SYS_COLOR */);
...
int32_t
ece391_create(uint8_t* buf){
    if (buf == NULL){return -1;}
    return __ece391_create(buf);
}

int32_t ece391_delete(uint8_t* buf){
    if (buf == NULL){return -1;}
    return __ece391_delete(buf);
}

int32_t ece391_copy(uint8_t* src, uint8_t* dsc){
    if (src == NULL || dsc == NULL){return -1;}
    return __ece391_copy(src, dsc);
}int32_t
ece391_ps(){
    return __ece391_ps();
}
...
int32_t
ece391_color(uint8_t text_color, uint8_t background_color){
    return __ece391_color(text_color, background_color);
}
